...
import { n as require_react_is$1, t as require_hoist_non_react_statics_cjs } from "./hoist-non-react-statics.cjs-CbxHbda3.js";
import { n as clsx_default } from "./clsx-D0Rpik7s.js";
	...
	module.exports = shouldUseNative() ? Object.assign : function(target, source) {
		...
		for (var s = 1; s < arguments.length; s++) {
			...
			if (getOwnPropertySymbols) {
				symbols = getOwnPropertySymbols(from$1);
...
var require_factoryWithTypeCheckers = /* @__PURE__ */ __commonJS({ "node_modules/prop-types/factoryWithTypeCheckers.js": ((exports, module) => {
	var ReactIs$1 = require_react_is$1();
...
function createContainer(options = {}) {
	...
	const Container = /* @__PURE__ */ import_react.forwardRef(function Container$1(inProps, ref) {
		...
		return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(ContainerRoot, {
			as: component,
			ownerState,
			className: clsx_default(useUtilityClasses$1(ownerState, componentName).root, className),
			ref,
			...other
		});
	});
...
//#endregion
export { clamp_default as $, orange_default as A, capitalize_default as At, useRtl as B, duration as C, getPath as Ct, green_default as D, deepmerge as Dt, createMixins as E, resolveBreakpointValues as Et, createContainer as F, emphasize as G, alpha as H, createCssVarsProvider as I, hexToRgb as J, getContrastRatio as K, InitColorSchemeScript as L, purple_default as M, grey_default as N, lightBlue_default as O, composeClasses as Ot, common_default as P, rgbToHex as Q, ThemeProvider_default as R, createTransitions as S, getValue as St, createTypography as T, mergeBreakpointsInOrder as Tt, darken as U, exactProp as V, decomposeColor as W, lighten as X, hslToRgb as Y, recomposeColor as Z, createThemeWithVars as _, StyleSheet as _t, useDefaultProps as a, generateUtilityClasses as at, createColorScheme as b, styleFunctionSx_default as bt, internal_createExtendSxProp as c, useThemeWithoutDefault_default as ct, slotShouldForwardProp_default as d, createBreakpoints as dt, useEnhancedEffect_default as et, GlobalStyles_default as f, styled$2 as ft, createTheme as g, createCache as gt, defaultTheme_default as h, CacheProvider as ht, svgIconClasses_default as i, styled_default$1 as it, red_default as j, ClassNameGenerator_default as jt, blue_default as k, require_prop_types as kt, styled_default as l, createTheme_default as lt, identifier_default as m, keyframes as mt, SvgIcon_default as n, getThemeProps$1 as nt, memoTheme_default as o, generateUtilityClass as ot, useTheme as p, css as pt, getLuminance as q, getSvgIconUtilityClass as r, resolveProps as rt, globalCss as s, useTheme_default as st, createSvgIcon as t, useThemeProps as tt, rootShouldForwardProp_default as u, createSpacing as ut, excludeVariablesFromRoot_default as v, _extends as vt, easing as w, handleBreakpoints as wt, getOverlayAlpha as x, createUnarySpacing as xt, shouldSkipGeneratingVar as y, extendSxProp as yt, useId as z };
//# sourceMappingURL=createSvgIcon-CltJxwlk.js.map