import { A as quartersInYear, C as millisecondsInWeek, D as minutesInYear, E as minutesInMonth, F as secondsInQuarter, I as secondsInWeek, L as secondsInYear, M as secondsInHour, N as secondsInMinute, O as monthsInQuarter, P as secondsInMonth, S as millisecondsInSecond, T as minutesInHour, _ as daysInWeek, b as millisecondsInHour, d as normalizeDates, f as startOfWeek, g as constructFrom, h as toDate, j as secondsInDay, k as monthsInYear, m as setDefaultOptions, n as enUS, p as getDefaultOptions, t as isSameWeek, v as daysInYear, w as minutesInDay, x as millisecondsInMinute, y as millisecondsInDay } from "./isSameWeek-CylLnt6F.js";
...
function formatDistanceStrict(laterDate, earlierDate, options) {
	...
	const dstNormalizedMinutes = (milliseconds$1 - (getTimezoneOffsetInMilliseconds(earlierDate_) - getTimezoneOffsetInMilliseconds(laterDate_))) / millisecondsInMinute;
...
function formatRFC3339(date, options) {
	...
	if (fractionDigits > 0) {
		...
		fractionalSecond = "." + addLeadingZeros(Math.trunc(milliseconds$1 * Math.pow(10, fractionDigits - 3)), fractionDigits);
	}
	let offset = "";
...
var DateParser = class extends Parser {
	...
	validate(date, value) {
		const isLeapYear$1 = isLeapYearIndex$1(date.getFullYear());
		const month = date.getMonth();
...
function sub(date, duration, options) {
	const { years = 0, months: months$1 = 0, weeks = 0, days: days$1 = 0, hours = 0, minutes = 0, seconds = 0 } = duration;
	const withoutDays = subDays(subMonths(date, months$1 + years * 12, options), days$1 + weeks * 7, options);
